...
import { clamp, lerp, smoothstep, fbm } from "../core/utils.js?v=34";
import { WORLD_W, WORLD_D, LAKES, lakeRadiusAt } from "../core/config.js?v=34";
import { rng } from "../core/context.js?v=34";
